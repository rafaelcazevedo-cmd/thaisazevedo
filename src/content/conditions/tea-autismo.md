---
title: Autismo
seoTitle: "Autismo (TEA): apoio neuropsicopedagógico à aprendizagem"
description: Como a neuropsicopedagogia apoia a aprendizagem e o desenvolvimento de crianças autistas (TEA) em São Paulo, respeitando o ritmo e o modo único de cada uma.
summary: O Autismo (TEA) é uma condição do neurodesenvolvimento que afeta a comunicação, a interação e o modo de aprender. A neuropsicopedagogia apoia a criança autista no desenvolvimento das habilidades de aprendizagem, respeitando o seu ritmo.
order: 6
keywords:
  - Autismo
  - neuropsicopedagogia Autismo
  - tea aprendizagem
signs:
  - Dificuldade com mudanças de rotina e transições
  - Desafios na comunicação e na interação com colegas
  - Foco intenso em alguns interesses e dispersão em outros
  - Dificuldade de atenção compartilhada nas atividades
...
> O diagnóstico do Autismo é **clínico e multidisciplinar**. A neuropsicopedagoga não diagnostica: atua no apoio à aprendizagem e ao desenvolvimento, em parceria com a família, a escola e os demais profissionais que acompanham a criança.
