...
keywords:
  ...
  - funções executivas
signs:
  - Distrai-se com facilidade e tem dificuldade de manter o foco
  - Começa muitas tarefas, mas não consegue terminá-las
  - Esquece lições, recados e perde materiais com frequência
  - Desorganização com cadernos, mochila e rotina de estudos
...
É comum que essas crianças sejam vistas como "desligadas", "preguiçosas" ou "bagunceiras". Na maioria das vezes, porém, elas se esforçam e ainda assim não conseguem se organizar sozinhas. O que falta não é vontade: são **estratégias** e o amadurecimento de habilidades como foco, planejamento, memória de trabalho e controle dos impulsos.

## Atenção e organização nem sempre são TDAH

Dificuldades de atenção e organização podem aparecer **com ou sem** um diagnóstico de [TDAH](/condicoes/tdah). Elas também surgem em momentos de sobrecarga, ansiedade ou simplesmente porque a criança ainda não desenvolveu boas estratégias de estudo. Por isso, não é preciso ter um diagnóstico para buscar ajuda.
